...
<script lang="ts">
    ...
    // local nodes
    import And from "$lib/nodes/pure/And.svelte";
    import Or from "$lib/nodes/pure/Or.svelte";
    ...
    import Contains from "$lib/nodes/pure/Contains.svelte";
    ...
    import GetVariable from "$lib/nodes/pure/GetVariable.svelte";
    ...
    const nodeList = Object.keys(nodeTypes);
